...
def main(train_path, test_path, results_file_path, sigmorphon_root_dir, input_dim, hidden_dim, epochs, layers,
    ...
    train_cluster_to_data_indices = common.get_single_pseudo_cluster(train_source_feat_dicts)
    test_cluster_to_data_indices = common.get_single_pseudo_cluster(test_source_feat_dicts)
