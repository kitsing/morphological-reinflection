...
def main():
    ...
    results_dir = '/Users/roeeaharoni/GitHub/morphological-reinflection/results/'
    #langs = ['russian', 'turkish']
    #langs = ['spanish', 'arabic']
    langs = ['georgian', 'german']
    ...
    for lang in langs:
        ...
        os.system('python pycnn_factored_inflection.py --cnn-mem 4096 --input=150 --hidden=150 --epochs=300 --layers=2 \
                  --optimization ADAM \
