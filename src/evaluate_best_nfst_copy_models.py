...
def main(train_path, test_path, results_file_path, sigmorphon_root_dir, input_dim, hidden_dim, epochs, layers,
    ...
    for cluster_index, cluster_type in enumerate(train_cluster_to_data_indices):
        ...
        try:
            ...
            predicted_templates = task1_joint_structured_inflection_neural_fst_single_copy.predict_templates(best_model,
                                                                                                 decoder_rnn,
                                                                                                 encoder_frnn,
                                                                                                 encoder_rrnn,
                                                                                                 alphabet_index,
            ...
            accuracy = task1_joint_structured_inflection_neural_fst_single_copy.evaluate_model(predicted_templates,
                                                                                           test_cluster_lemmas,
                                                                                           test_cluster_feat_dicts,
                                                                                           test_cluster_words,
                                                                                           feature_types,
            ...
            for i in test_cluster_to_data_indices[cluster_type]:
                ...
                inflection = task1_joint_structured_inflection_neural_fst_single_copy.instantiate_template(
