...
Options:
  ...
  --majority                    perform simple majority vote instead of majority decoding
"""
...
def load_best_model(morph_index, alphabet, results_file_path, input_dim, hidden_dim, layers, feature_alphabet,
    ...
    model, encoder_frnn, encoder_rrnn, decoder_rnn = task1_single_ms2s.build_model(alphabet, input_dim, hidden_dim,
