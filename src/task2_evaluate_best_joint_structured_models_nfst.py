...
def main(train_path, test_path, results_file_path, sigmorphon_root_dir, input_dim, hidden_dim, epochs, layers,
    ...
    for cluster_index, cluster_type in enumerate(train_cluster_to_data_indices):
        ...
        try:
            ...
            predicted_templates = task2_joint_structured_inflection_neural_fst.predict_templates(best_model, decoder_rnn,
            ...
            accuracy = task2_joint_structured_inflection_neural_fst.evaluate_model(predicted_templates, test_cluster_source_words,
