...
Usage:
  task1_joint_inflection_feedback_fix.py [--cnn-mem MEM][--input=INPUT] [--hidden=HIDDEN] [--feat-input=FEAT] [--epochs=EPOCHS]
...
def one_word_loss(model, encoder_frnn, encoder_rrnn, decoder_rnn, lemma, feats, word, alphabet_index, feat_index,
    ...
    for i, word_char in enumerate(word):
        ...
        prev_output_vec = char_lookup[alphabet_index[word_char]]
