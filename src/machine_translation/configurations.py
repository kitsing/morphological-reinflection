...
def get_config_reinflection():
    # (i) the morphological tags of the source form,
    # (ii) the morphological tags of the target form and
    # (iii) the sequence of letters of the source form
    config = {}
    ...
    # Dimension of the character embedding matrix in encoder/decoder
    config['enc_embed'] = 300
    config['dec_embed'] = 300

    # Where to save model, this corresponds to 'prefix' in groundhog
    config['saveto'] = 'search_model_morph'
    ...
    # Source and target vocabularies
    config['src_vocab'] = datadir + 'vocab.train.in-train.out.train.in.pkl'
    config['trg_vocab'] = datadir + 'vocab.train.in-train.out.train.out.pkl'

    # Source and target datasets
    config['src_data'] = datadir + 'train.in.tok.shuf'
    config['trg_data'] = datadir + 'train.out.tok.shuf'
