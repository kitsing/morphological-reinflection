...
def main(train_path, test_path, results_file_path, sigmorphon_root_dir, input_dim, hidden_dim, epochs, layers,
    ...
    for cluster_index, cluster_type in enumerate(train_cluster_to_data_indices):
        ...
        try:
            ...
            predicted_templates = task1_joint_structured_inflection_feedback_fix.predict_templates(best_model, decoder_rnn,
            ...
            for i in test_cluster_to_data_indices[cluster_type]:
                ...
                inflection = task1_joint_structured_inflection_feedback_fix.instantiate_template(predicted_templates[joint_index],
                                                                                    test_lemmas[i])
